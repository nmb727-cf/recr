    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(blank=True, choices=[('self', 'Self Registered'), ('agency', 'Agency'), ('company', 'Company'), ('linkedin', 'LinkedIn'), ('referral', 'Referral'), ('job_board', 'Job Board'), ('passport', 'Talent Passport'), ('cafe', 'Interview Cafe'), ('other', 'Other')], max_length=100)),
