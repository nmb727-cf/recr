...
urlpatterns = [
    ...
    path('email/feature-status', account_views.EmailFeatureStatusView.as_view(), name='email-feature-status'),
    path('email/oauth-status', account_views.EmailOAuthStatusView.as_view(), name='email-oauth-status'),
    path('email-accounts/', account_views.EmailAccountListView.as_view(), name='email-account-list'),
    path('email-accounts/gmail/connect/initiate', account_views.GmailConnectInitiateView.as_view(), name='email-gmail-initiate'),
    path('email-accounts/gmail/callback', account_views.GmailCallbackView.as_view(), name='email-gmail-callback'),
    path('email-accounts/microsoft/connect/initiate', account_views.MicrosoftConnectInitiateView.as_view(), name='email-microsoft-initiate'),
    path('email-accounts/microsoft/callback', account_views.MicrosoftCallbackView.as_view(), name='email-microsoft-callback'),
    path('email-accounts/<uuid:pk>/set-default', account_views.SetDefaultSenderView.as_view(), name='email-set-default'),
    path('email-accounts/<uuid:pk>/test', account_views.EmailAccountTestView.as_view(), name='email-account-test'),
    path('email-accounts/<uuid:pk>/reconnect', account_views.EmailAccountReconnectView.as_view(), name='email-account-reconnect'),
    path('email-accounts/<uuid:pk>/disconnect', account_views.EmailAccountDisconnectView.as_view(), name='email-account-disconnect'),

    # SMTP Phase-2 ready
    path('email-accounts/smtp', account_views.SMTPAccountCreateView.as_view(), name='email-smtp-create'),
    path('email-accounts/smtp/<uuid:pk>', account_views.SMTPAccountPatchView.as_view(), name='email-smtp-patch'),

    # Preferences
    path('email-preferences/', account_views.EmailPreferenceView.as_view(), name='email-preferences'),

    # Templates and quick replies
    path('email-templates/', template_views.EmailTemplateListCreateView.as_view(), name='email-template-list'),
    path('email-templates/<uuid:pk>', template_views.EmailTemplateUpdateView.as_view(), name='email-template-patch'),
    path('email-templates/<uuid:pk>/duplicate', template_views.EmailTemplateDuplicateView.as_view(), name='email-template-duplicate'),
    path('email-templates/<uuid:pk>/preview', template_views.EmailTemplatePreviewView.as_view(), name='email-template-preview'),

    path('quick-replies/', template_views.QuickReplyListCreateView.as_view(), name='quick-reply-list'),
    path('quick-replies/<uuid:pk>', template_views.QuickReplyUpdateView.as_view(), name='quick-reply-patch'),

    # Send / preview
    path('email/send', dispatch_views.EmailSendView.as_view(), name='email-send'),
    path('email/send-test', dispatch_views.EmailSendTestView.as_view(), name='email-send-test'),
    path('email/render-preview', dispatch_views.EmailRenderPreviewView.as_view(), name='email-render-preview'),
    path('email/render-template', dispatch_views.EmailRenderTemplateView.as_view(), name='email-render-template'),

    # History / audit / webhooks
    path('email-messages/', dispatch_views.EmailMessageListView.as_view(), name='email-message-list'),
    path('email-messages/<uuid:pk>', dispatch_views.EmailMessageDetailView.as_view(), name='email-message-detail'),
    path('email-audit/', audit_views.EmailAuditListView.as_view(), name='email-audit-list'),
    path('email-webhooks/<str:provider>', webhook_views.EmailWebhookView.as_view(), name='email-webhook'),

    # ── Automation delivery observability ───────────────────────────────────
    path('email/deliveries/', dispatch_views.EmailDeliveryListView.as_view(), name='email-delivery-list'),
    path('email/deliveries/<uuid:delivery_id>/', dispatch_views.EmailDeliveryDetailView.as_view(), name='email-delivery-detail'),
    path('email/deliveries/<uuid:delivery_id>/retry/', dispatch_views.EmailDeliveryRetryView.as_view(), name='email-delivery-retry'),
    path('email/health/', dispatch_views.EmailHealthView.as_view(), name='email-health'),

    # ── Multi-channel engine — observability ────────────────────────────────
    path('deliveries/', channel_views.CommunicationDeliveryListView.as_view(), name='channel-delivery-list'),
    path('deliveries/<uuid:delivery_id>/', channel_views.CommunicationDeliveryDetailView.as_view(), name='channel-delivery-detail'),
    path('deliveries/<uuid:delivery_id>/retry/', channel_views.CommunicationDeliveryRetryView.as_view(), name='channel-delivery-retry'),
    path('channel-health/', channel_views.ChannelHealthView.as_view(), name='channel-health'),
    path('fallback-jobs/', channel_views.FallbackJobListView.as_view(), name='channel-fallback-jobs'),
    path('channel-stats/', channel_views.ChannelStatsView.as_view(), name='channel-stats'),

    # ── Multi-channel engine — tenant config ────────────────────────────────
    path('channel-configs/', channel_views.TenantChannelConfigListView.as_view(), name='channel-config-list'),
    path('channel-configs/<uuid:config_id>/', channel_views.TenantChannelConfigDetailView.as_view(), name='channel-config-detail'),
]
