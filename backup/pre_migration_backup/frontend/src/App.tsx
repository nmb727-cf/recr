          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route 
                ...
                element={ 
                  <Protected roles={["tenant_admin", "super_admin", "hr_manager"]}> 
              ...
              <Route 
                path="/control-tower" 
                element={ 
                  <Protected roles={["tenant_admin", "super_admin", "hr_manager", "hiring_manager"]}> 
                    <TalentControlTower /> 
                  </Protected> 
                } 
              />
              ...
              <Route
                path="/jobs/templates"
                element={
                  <Protected roles={['tenant_admin', 'super_admin', 'hr_manager', 'recruiter', 'hiring_manager']}>
                    <JobTemplates />
                  </Protected>
                }
              />
              ...
              <Route
                ...
                element={
                  <Protected roles={['tenant_admin', 'super_admin', 'hr_manager', 'recruiter', 'hiring_manager', 'viewer']}>
              ...
              <Route
                ...
                element={
                  <Protected roles={['tenant_admin', 'super_admin', 'hr_manager', 'hiring_manager', 'recruiter']}>
